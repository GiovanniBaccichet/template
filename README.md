...
<p align="center">
  ...
  <p align="center">
    This is the template I use for all my repos on GitHub
    <br />
...
I'm making this repository since in the last period I used GitHub a lot, finding myself in the same situation every time: modifying the README, remembering the licensing and customizing the `.gitignore`. A template is much more efficient.
